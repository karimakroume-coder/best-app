...
# 1. NEW FILE - frontend/src/CreatorOutreachKit.js
os.makedirs("frontend/src", exist_ok=True)
with open("frontend/src/CreatorOutreachKit.js", "w", encoding="utf-8") as f:
    f.write(r'''import React, { useState, useRef, useCallback } from 'react';
...
''')
print("Wrote frontend/src/CreatorOutreachKit.js")

# 2. NEW FILE - migrations/creator_referrals_migration.sql
os.makedirs("migrations", exist_ok=True)
with open("migrations/creator_referrals_migration.sql", "w", encoding="utf-8") as f:
    f.write('''-- Creator referral tracking
...
''')
print("Wrote migrations/creator_referrals_migration.sql")

print("\nDONE. New files written to best-app root.")
print("Now hand App.js / Creators.js / main.py edits to Claude Code, then push.")
