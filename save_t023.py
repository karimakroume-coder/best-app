...
# T023 — Personal Best 100 Spatial Map View
# New component to add to SpatialMap.js
...
ref_path = os.path.join(BASE, "frontend", "src", "PersonalBestMap_T023.js")
with open(ref_path, 'w', encoding='utf-8') as f:
    f.write(personal_best_map)
print(f"Saved: frontend/src/PersonalBestMap_T023.js")
print()
print("NEXT STEP — Give Claude Code this instruction:")
print("""
Read CLAUDE.md for context.
Read frontend/src/SpatialMap.js
Read frontend/src/PersonalBestMap_T023.js

T023 — Apply Personal Best Spatial Map:

1. Copy the PersonalBestMap component
   from PersonalBestMap_T023.js
   into SpatialMap.js before the main component.

2. In SpatialMap.js where currentMap === 'my-best'
   renders (in the map switch section):
   Replace the current MY BEST placeholder with:
   <PersonalBestMap
     userId={userId}
     onSwitchToWorld={() => setCurrentMap('world-best')}
     discoveryScore={discoveryScore}
   />

3. Delete PersonalBestMap_T023.js after copying.

4. Make sure the zoom toggle (1x / 3x3)
   works within PersonalBestMap independently.

5. Add to existing style block:
...
Push to GitHub main.
Run vercel --prod.
Commit: T023 — Personal Best spatial map view
""")
