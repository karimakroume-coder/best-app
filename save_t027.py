...
# T027 additions for Creators.js
creators_additions = """
...
ref_path = os.path.join(BASE, "frontend", "src", "CreatorsAdditions_T027.js")
with open(ref_path, 'w', encoding='utf-8') as f:
    f.write(creators_additions)
print(f"Saved: frontend/src/CreatorsAdditions_T027.js")

print()
print("NEXT STEP — Give Claude Code this instruction:")
print("""
Read CLAUDE.md for context.
Read frontend/src/Creators.js
Read frontend/src/CreatorsAdditions_T027.js

T027 — Apply Creators page improvements:

1. Copy LiveStats and ApplicationModal components
   from CreatorsAdditions_T027.js
   into Creators.js (before the main Creators component)

2. In Creators.js add state:
   const [showModal, setShowModal] = useState(false)

3. Add <LiveStats /> below the hero section
   and above the four benefit cards.

4. Replace the APPLY NOW button onClick with:
   onClick={() => setShowModal(true)}
   onTouchEnd={(e) => { e.preventDefault(); setShowModal(true); }}

5. Add at bottom of Creators return:
   {showModal && (
     <ApplicationModal onClose={() => setShowModal(false)} />
   )}

6. Delete CreatorsAdditions_T027.js after copying.

7. Also run in Supabase SQL Editor:
...
Push to GitHub main.
Run vercel --prod.
Commit: T027 — Creators page improvements
""")
